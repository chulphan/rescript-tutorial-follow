...
SimpleTest.assertEqual("B", "B", "[exercise 4] A -> B");

SimpleTest.assertEqual("C", "C", "[exercise 4] B -> C");

SimpleTest.assertEqual("A", "A", "[exercise 4] C -> A");
...
function bookToHTML(book) {
  return "<div>\n    <h2>" + book.title + ": " + book.tagline + "</h2>\n    <p>" + String(book.availableInStock) + " new " + bookFormatToString(book.format) + " available in stock</p>\n</div>";
}
