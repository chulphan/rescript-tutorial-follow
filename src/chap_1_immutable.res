...
/*
  ...
  a) What is the value of `book`? Deep Work: Rules for Focused Success in a Distracted World
  b) What is the value of `book2`? Real World OCaml: Functional programming for the masses 
  c) When you remove the shadowed bindings inside the block scope what is the
  new value of `book2`? same as a)
